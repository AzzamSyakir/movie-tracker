                                                ...
                                                <div class="movie-details">
                                                    <div class="movie-rating-title">
                                                        <div class="movie-rating">
                                                            ...
                                                            <span
                                                                class="rating">{{ number_format($movie['vote_average'], 1) }}</span>
                                                        </div>
                                                        <h2 class="movie-title">{{ $movie['title'] }}</h2>
                                                    </div>
                                                    <div class="button-group">
                                                        <form id="watchlist-form-{{ $movie['id'] }}"
                                                            action="{{ route('AddWatchlist', ['movieId' => $movie['id']]) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            <button type="button" class="watchlist-btn"
                                                                onclick="document.getElementById('watchlist-form-{{ $movie['id'] }}').submit();">
                                                                <i class="fa fa-plus-circle"></i> Watchlist
                                                            </button>
                                                        </form>

                                                        <button class="trailer-btn"
                                                            onclick="window.location.href='{{ route('MovieDetail', ['movieId' => $movie['id']]) }}'">
