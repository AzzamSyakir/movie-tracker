...
<div class="settings-container">
    ...
    <form action="{{ route('UpdateUser') }}" method="POST" onsubmit="return validateForm()">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" value="{{$user['name']}}" data-original-value="{{$user['name']}}" oninput="checkIfPasswordShouldBeEnabled()">
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" value="{{$user['email']}}" data-original-value="{{$user['email']}}" oninput="checkIfPasswordShouldBeEnabled()">
            @error('email')
                <div class="error">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <div class="password-input" style="position: relative;">
                <input type="password" id="password" name="password" placeholder="Enter new password" class="disabled-input" disabled>
